...
class ThemeHouse_FontAweAcp_Option
{
    ...
    {
        return XenForo_ViewAdmin_Helper_Option::renderOptionTemplateInternal('th_option_list_option_textboxes_fontaweacp', $view, $fieldPrefix, $preparedOption, $canEdit);
    } /* END renderOption */
}